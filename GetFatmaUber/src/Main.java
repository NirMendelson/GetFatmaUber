...
public class Main {
	...
	public static void main(String[] args) {
	    ...
	    Driver driver1 = new Driver(1, "a", "050", 2, new String[]{"B"});
	    Driver driver2 = new Driver(2, "b", "050", 2, new String[]{"B"});
	    Driver driver3 = new Driver(3, "c", "050", 2, new String[]{"B"});
	    Driver driver4 = new Driver(4, "d", "050", 2, new String[]{"B"});
	    Driver driver5 = new Driver(5, "e", "050", 2, new String[]{"B"});
	    Driver driver6 = new Driver(6, "f", "050", 2, new String[]{"B"});
	    Driver driver7 = new Driver(7, "g", "050", 2, new String[]{"B"});
	    Driver driver8 = new Driver(8, "h", "050", 2, new String[]{"B"});
	    Driver driver9 = new Driver(9, "i", "050", 2, new String[]{"B"});
	    Driver driver10 = new Driver(10, "j", "050", 2, new String[]{"B"});
	    Driver driver11 = new Driver(11, "k", "050", 2, new String[]{"B"});
	    Driver driver12 = new Driver(12, "l", "050", 2, new String[]{"A"});
	    Driver driver13 = new Driver(13, "m", "050", 2, new String[]{"A"});
	    Driver driver14 = new Driver(14, "n", "050", 2, new String[]{"A"});
	    Driver driver15 = new Driver(15, "o", "050", 2, new String[]{"A"});
	    Driver driver16 = new Driver(16, "p", "050", 2, new String[]{"A"});
	    ...
	    ServiceEmployee employee9 = new ServiceEmployee(1, "a", 0, 19, 'M', "Haifa");
	    ServiceEmployee employee10 = new ServiceEmployee(1, "b", 0, 19, 'M', "Haifa");
	    ServiceEmployee employee11 = new ServiceEmployee(1, "c", 0, 19, 'M', "Haifa");
	    ServiceEmployee employee12 = new ServiceEmployee(1, "d", 0, 19, 'M', "Haifa");
	    ...
	    ServiceEmployee employee1 = new ServiceEmployee(1, "i", 0, 19, 'M', "Beer Sheva");
	    ServiceEmployee employee2 = new ServiceEmployee(1, "j", 0, 19, 'M', "Beer Sheva");
	    ServiceEmployee employee3 = new ServiceEmployee(1, "k", 0, 19, 'M', "Beer Sheva");
	    ServiceEmployee employee4 = new ServiceEmployee(1, "l", 0, 19, 'M', "Beer Sheva");
